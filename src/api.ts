...
> extends HttpClient<SecurityDataType> {
  ...
  coins = {
    ...
    historyDetail: (
      id: string,
      query: { date: string; localization?: string },
      params: RequestParams = {}
    ) =>
      this.request<void, any>({
    ...
    /**
     * @description Get historical market data include price, market cap, and 24h volume (granularity auto) <b>Minutely data will be used for duration within 1 day, Hourly data will be used for duration between 1 day and 90 days, Daily data will be used for duration above 90 days.</b>
     *
     * @tags coins
     ...
     *
     * @tags coins
     * @name StatusUpdatesDetail
     * @summary Get status updates for a given coin
     * @request GET:/coins/{id}/status_updates
     */
    statusUpdatesDetail: (
      id: string,
    ...
    /**
     * @description Candle's body: 1 - 2 days: 30 minutes 3 - 30 days: 4 hours 31 and before: 4 days
     *
     * @tags coins
     * @name OhlcDetail
    ...
    ohlcDetail: (
      id: string,
      query: { vs_currency: string; days: number },
      params: RequestParams = {}
    ) =>
  ...
  exchanges = {
     ...
     */
    exchangesList: (
      query?: { per_page?: number; page?: string },
      params: RequestParams = {}
    ) =>
      this.request<void, any>({
        path: `/exchanges`,
     ...
     * @request GET:/exchanges/{id}/status_updates
     */
    statusUpdatesDetail: (
      id: string,
      query?: { per_page?: number; page?: number },
      ...
      this.request<void, any>({
        path: `/exchanges/${id}/status_updates`,
        method: "GET",
        query: query,
        ...params,
      }),
  ...
  financePlatforms = {
     ...
     *
     * @tags finance
     * @name FinancePlatformsList
     * @summary List all finance platforms
     * @request GET:/finance_platforms
     */
    financePlatformsList: (
      page?: string,
      query?: { per_page?: number },
      params: RequestParams = {}
    ) =>
      this.request<void, any>({
        path: `/finance_platforms`,
        method: "GET",
        query: query,
        ...params,
      }),
  ...
  financeProducts = {
     ...
     *
     * @tags finance
     * @name FinanceProductsList
     * @summary List all finance products
     * @request GET:/finance_products
     */
    financeProductsList: (
      page?: string,
      startAt?: string,
  ...
  derivatives = {
     ...
     */
    exchangesList: (
      query?: { order?: string; per_page?: number; page?: number },
      params: RequestParams = {}
    ) =>
      this.request<void, any>({
